...
RESULT_FOLDER = os.path.join('D:/flask_working_webAPP/defect-Detection-Classification/deployment/static')
...
def predict():
    if request.method == 'POST':
        ...
        results.save(save_dir='D:/flask_working_webAPP/defect-Detection-Classification/deployment/static')
        filename = 'image0.jpg'
